...
public class XML {
	...
	/**
	 * Big5 encode to UTF-8
	 * @param str
	 * @return
	 */
	public String Big5toUTF8(String str){
		String sRtn="";
		try {
			sRtn = new String(str.getBytes("big5"), "UTF-8");
		} catch (UnsupportedEncodingException e) {
			LogUtil.logError(_log, "UnsupportedEncodingExceptionn: " + e.getMessage());
			throw new EJBException(e.getMessage());
		}
		return sRtn;
	}
